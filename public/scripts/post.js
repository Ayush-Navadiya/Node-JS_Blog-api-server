...
let formOPD = function () {
        var dataTable = $('#kt_datatable').DataTable({
            ...
            },
            {
                ...
                orderable:false,
                render: function (data, type, full, meta) {
                    var action = '<div class="row"><a href="bloged_display/?_id='+data+'" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3 text-center">'+
                                        ...
                                        '</span>'+
                                    '</a>'+
                                    '<a href="./api/Blogdl_click/?_id='+data+'" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3 text-center">'+
                                        '<span class="svg-icon svg-icon-md svg-icon-primary">'+
                                            '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">'+
                                                '<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">'+
                                                    '<rect x="0" y="0" width="24" height="24"></rect>'+
